...
@section('content')
    ...
    {!! Form::model(null, ['method' => 'post', 'route' => ['routines.store']]) !!}
        ...
        <div class="portlet-footer">
            <div class="form-group">
                <a href="{{ route('routines.index') }}" type="button" class="btn btn-info" style="margin-right: 5px;"><i class="fa fa-backward" aria-hidden="true"></i>
                Back</a>
